...
/// Minimalist Register Page
/// Name/email/password/confirm password with mock validation
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ToastOverlay.show(context, '注册成功');
  ...
  Widget _buildRegisterButton(ThemeColors colors) {
    return SizedBox(
