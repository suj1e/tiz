...
import static com.nexora.auth.adapter.infra.job.OutboxPublisherJob.JOB_NAME;
import static com.nexora.auth.adapter.infra.job.RefreshTokenCleanupJob.REFRESH_TOKEN_CLEANUP_JOB;
import static com.nexora.auth.adapter.infra.job.AccountUnlockJob.ACCOUNT_UNLOCK_JOB;
...
public class QuartzConfig {
    ...
    public JobDetail outboxPublisherJobDetail() {
        return JobBuilder.newJob()
            .ofType(com.nexora.auth.adapter.infra.job.OutboxPublisherJob.class)
            .storeDurably(true)
    ...
    public JobDetail refreshTokenCleanupJobDetail() {
        return JobBuilder.newJob()
            .ofType(com.nexora.auth.adapter.infra.job.RefreshTokenCleanupJob.class)
            .storeDurably(true)
    ...
    public JobDetail accountUnlockJobDetail() {
        return JobBuilder.newJob()
            .ofType(com.nexora.auth.adapter.infra.job.AccountUnlockJob.class)
            .storeDurably(true)
