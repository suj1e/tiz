...
JAR_FILE="tizsrv-boot/build/libs/tizsrv-boot-${VERSION}.jar"
PID_FILE=".tizsrv.pid"
LOG_FILE="logs/tizsrv.log"
GC_LOG_FILE="logs/gc.log"
HEALTH_URL="http://localhost:40009//tiz/actuator/health/readiness"
MANAGEMENT_PORT=40009
